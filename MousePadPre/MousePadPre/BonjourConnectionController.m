...
- (void)netServiceDidStop:(NSNetService *)sender {
    [TimeMine setTimeMineLocalizedFormat:@"2014/10/12 0:00:44" withLimitSec:100000 withComment:@"NetServiceの探索終了が行われた。接続されてない場合自動的に再接続、なんだけど実際どの単位での準備が必要かわかってない。"];
}
